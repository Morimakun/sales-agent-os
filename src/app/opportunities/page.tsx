  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-3">
        <h1 className="text-xl font-bold">案件候補一覧</h1>
      ...
      <div className="flex flex-wrap gap-3 text-xs text-slate-500 mb-3">
        <span>エクスポート:</span>
        <a href="/api/export/opps-csv" className="text-blue-600 hover:underline">案件候補CSV</a>
        <a href="/api/export/today-md" className="text-blue-600 hover:underline">今日のアクションMD</a>
        <a href="/api/export/candidates-md" className="text-blue-600 hover:underline">商談化候補MD</a>
        <a href="/api/export/drafts-md" className="text-blue-600 hover:underline">送信予定文面MD</a>
      </div>
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {opportunities.length === 0 && (
              <tr><td colSpan={8} className="px-3 py-6 text-center text-slate-400">該当する案件候補がありません</td></tr>
            )}
            {opportunities.map((o) => (
              <OpportunityRow key={o.id} o={{
                id: o.id,
